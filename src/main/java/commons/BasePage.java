...
public class BasePage {
	...
	public void waitForElementInvisible(WebDriver driver, String locator) {
		...
		overrideImplicitWait(driver, Duration.ofSeconds(shortTimeout));
		explicitWait.until(ExpectedConditions.invisibilityOfElementLocated(getByXpath(locator)));
		overrideImplicitWait(driver, Duration.ofSeconds(longTimeout));
	}
	...
	public void overrideImplicitWait(WebDriver driver, Duration duration) {
